...
$target_file = "../../" . $target_dir . "notula-" . $user_id . "-" . $pic_kegiatan_id .  "-" . $datefilename . "." . $extFiles;

$fileNameForDB = "notula-" . $user_id . "-" . $pic_kegiatan_id . "-" . $datefilename . "." . $extFiles;
...
else 
{
  if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) 
  {
  	$query = "INSERT INTO " .
				...
				"VALUES " . 
				"('$fileNameForDB', 'notula', '$datetimenow', '".$user_id."', '".$pic_kegiatan_id."')";
		//echo $query;
		...
		$queryLog = "INSERT INTO ".$simplePAGE['tableprefix']."log ( logTYPE, logCONTENT, logDATETIME, userID) " .
							"VALUES " .
							"( 'upload file notula kegiatan', '".addslashes($query)."', '".date("Y-m-d H:i:s")."', '$user_id' )";
