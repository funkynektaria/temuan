...
$target_file = "../../" . $target_dir . "laporankegiatan-" . $user_id . "-" . $pic_kegiatan_id .  "-" . $datefilename . "." . $extFiles;

$fileNameForDB = "laporankegiatan-" . $user_id . "-" . $pic_kegiatan_id . "-" . $datefilename . "." . $extFiles;
...
else 
{
  if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) 
  {
  	$query = "INSERT INTO " .
				...
				"VALUES " . 
				"('$fileNameForDB', 'laporan_kegiatan', '$datetimenow', '".$user_id."', '".$pic_kegiatan_id."')";
		//echo $query;
		...
		$queryLog = "INSERT INTO ".$simplePAGE['tableprefix']."log ( logTYPE, logCONTENT, logDATETIME, userID) " .
							"VALUES " .
							"( 'upload file laporan kegiatan', '".addslashes($query)."', '".date("Y-m-d H:i:s")."', '$user_id' )";
