...
$pic_kegiatan_id = $_POST['kid'];
$target_dir = $simplePAGE['uploaddirkegiatan'];
...
$target_file = "../../" . $target_dir . "laporanproduk-" . $user_id . "-" . $pic_kegiatan_id .  "-" . $datefilename . "." . $extFiles;

$fileNameForDB = "laporanproduk-" . $user_id . "-" . $pic_kegiatan_id . "-" . $datefilename . "." . $extFiles;
...
else 
{
  ...
  {
  	$query = "INSERT INTO " .
				$simplePAGE['tableprefix'] . "kegiatan_dokumen " .
				"(kd_loc,kd_type,kd_datetime, user_id,kegiatan_id) " .
				"VALUES " . 
				"('$fileNameForDB', 'laporan_produk', '$datetimenow', '".$user_id."', '".$pic_kegiatan_id."')";
		//echo $query;
		...
		$queryLog = "INSERT INTO ".$simplePAGE['tableprefix']."log ( logTYPE, logCONTENT, logDATETIME, userID) " .
							"VALUES " .
							"( 'upload file laporan produk kegiatan', '".addslashes($query)."', '".date("Y-m-d H:i:s")."', '$user_id' )";
