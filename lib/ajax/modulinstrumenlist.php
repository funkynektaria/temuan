...
?>
	                  	...
	                  	<select name="instrumen_sub_id" id="instrumen_sub_id" class="form-control">
...
?>
											<label class="form-control-label">Pilih Instrumen</label>
	                  	<select name="instrumen_sub_id" id="instrumen_sub_id" class="form-control" onchange="getJawabanToUserList(this.value, kode_propinsi.value, kode_kab_kota.value)">
	                  		<option value="--Instrumen--">--Instrumen--</option>
	                  		<?php
